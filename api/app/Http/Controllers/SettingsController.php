...
class SettingsController extends Controller
{
	...
	public function saveBuyNowSettings(Request $request)
    {
		...
		if($request->has("selectedTheme")){
			$selectedTheme = $request->input("selectedTheme");
		}
		if($request->has("otherThemeText")){
			$otherThemeText = $request->input("otherThemeText");
		}
		...
		$settingObj->selectedTheme = $selectedTheme;
		$settingObj->selectedOtherTheme = $otherThemeText;
