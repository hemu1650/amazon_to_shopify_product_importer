...
(function() {
    ...
    angular
        .module('ngAA')
        .controller('ngAAAuthCtrl', ['$rootScope', '$scope', 'ngAAUser', 'ngAAConfig', '$state','$stateParams', function($rootScope, $scope, ngAAUser, ngAAConfig, $state,$stateParams) {
            //user model
            $scope.user = {};

			$scope.user.key = $stateParams.key;
            //signin current
                ...
                ngAAUser
                    ...
                    .then(function(response) {
                       // console.log(JSON.stringify(response.data));
                        ...
                        if(response.data.user.skuconsumed === 0){
                            $state.go('admin.addproduct');
                        } else {
