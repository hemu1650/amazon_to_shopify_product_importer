    ...
    .config(['$ocLazyLoadProvider', function($ocLazyLoadProvider) {
        $ocLazyLoadProvider.config({
            ...
            modules: [
                 ...
                 ***************************************************************/
                {
                    name:'ProductServiceModule',
                    files:[
                        'app/modules/product/services/ProductService.js'
                    ]
                },
                {
                    name:'ReviewServiceModule',
                    files:[
                        'app/modules/reviews/services/ReviewService.js'
                    ]
                },
                {
                    name:'AmzConfigServiceModule',
                    files:[
                        'app/modules/amzconfig/services/AmzConfigService.js'
                    ]
                },
				{
                    name:'SettingsServiceModule',
                    files:[
                        'app/modules/settings/services/SettingsService.js'
                    ]
                },
                {
                ...
                {
                    name:'ContactServiceModule',
                    files:[
                        'app/modules/contact/services/ContactService.js'
                    ]
                },                
