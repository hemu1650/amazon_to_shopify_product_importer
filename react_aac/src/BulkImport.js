...
export default function BulkImport() {
    ...
    (e) => {
      ...
      reader.onload = () => {
        ...
        axios
          ...
          .then((response) => {
            // Handle success
            console.log('responce-data', response.data[0]);
            const responceData = response.data[0];
            toast.success(responceData);
            setSelectedOption("");
  ...
  return (
    <Page title={"Bulk Import"}>
      ...
      <div style={{ height: '500px', paddingTop: '20px' }} className="bulkproductlist" id="bulkproductlist">
        <Card>
